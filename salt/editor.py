...
class Editor:
    def __init__(self, onnx_models_path, dataset_path, categories=None, coco_json_path=None):
        ...
        self.status_categories = self.dataset_explorer.get_review_status()
        self.image_id = 0
        self.category_id = 0
    ...
    def get_categories(self, get_colors=True):
        if get_colors:
    ...
    def delete_annotations(self):
        self.dataset_explorer.delete_annotation(self.image_id)
        self.__draw()
